const apiKey = '9135047a0f4adfbf0a792c0e30c0cc25'; // Reemplaza con tu clave API
...
async function showMovieDetails(movieId) {
    try {
        ...
        detailsContainer.innerHTML = `
            ...
            <img src="https://image.tmdb.org/t/p/w500${movie.poster_path}" alt="${movie.title}">
        `;
        movieDetails.classList.remove('hidden'); // Muestra los detalles
...
displayFavorites(); // Muestra las películas favoritas guardada